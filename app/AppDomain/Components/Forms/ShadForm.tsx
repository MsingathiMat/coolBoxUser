  ...
  function onSubmit(data: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      (Object.keys(data) as (keyof FormType)[]).forEach((key) => {
        if (key !== "poster" && key !== "date") {
          // Skip the poster key since it's already appended
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <div className=" CENTER h-full gap-4 relative items-start   ">
          <div
            id="LEFT"
            className=" p-4  bg-slate-200 w-[400px] CENTER flex-col items-start gap-4"
          >
            <FormField
          ...
          <div
            id="RIGHT"
            className=" CENTER !justify-start   flex-col !items-start gap-4"
          >
            <FormField
              control={form.control}
              name="eventType"
